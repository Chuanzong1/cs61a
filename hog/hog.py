...
def is_always_roll(strategy, goal=GOAL):
    ...
    for score in range(0,goal):
        for opp in range(0,goal):
            if strategy(score,opp)!=first_roll:
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    """
    # BEGIN PROBLEM 9
    'i don`t understand the question now in 2024-11-15'
    "*** YOUR CODE HERE ***"
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    return 0 if boar_brawl(score,opponent_score)>=threshold else num_rolls  # Remove this line once implemented.
    # END PROBLEM 10
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    if sus_points(score+boar_brawl_score)-score>=threshold:
        return 0
