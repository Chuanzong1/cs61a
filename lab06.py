...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self._transaction_count, before_balance, self.balance))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self._transaction_count, before_balance, before_balance))
            self._transaction_count += 1
...
class Server:
    ...
    def register_client(self, client):
        """Add a client to the clients mapping."""
